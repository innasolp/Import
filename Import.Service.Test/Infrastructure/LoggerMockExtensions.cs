...
public static class LoggerMockExtensions
{
    ...
    private static void VerifyMessage<TLogger>(this Mock<TLogger> loggerMock, LogLevel logLevel, Exception? e, Func<Exception,Exception,bool> compareException, string message, Func<string,string,bool> compareMessage)
        where TLogger : class, ILogger
    {
        loggerMock.Verify(l => l.Log(
           It.Is<LogLevel>(v => v == logLevel),
           It.IsAny<EventId>(),
           It.Is<It.IsAnyType>((v, t) => compareMessage(v.ToString(), message)),
    ...
    public static void VerifyWarning<TLogger>(this Mock<TLogger> loggerMock, string message, Func<string, string, bool> compareMessage)
        where TLogger : class, ILogger
    {
        loggerMock.VerifyMessage(LogLevel.Warning, null, (v,e)=>true, message, compareMessage);
    }
    ...
    public static void VerifyWarning<TLogger>(this Mock<TLogger> loggerMock, Exception exception, Func<Exception,Exception,bool> compareException,
        string message, Func<string, string, bool> compareMessage)
        where TLogger : class, ILogger
    {
        loggerMock.VerifyMessage(LogLevel.Warning, exception, compareException, message, compareMessage);
    }
    ...
    public static void VerifyError<TLogger>(this Mock<TLogger> loggerMock, Exception? exception, Func<Exception,Exception,bool> compareException,
        ...
        where TLogger : class, ILogger
    {
        loggerMock.VerifyMessage(LogLevel.Error, exception, compareException, message, compareMessage);
    }
}